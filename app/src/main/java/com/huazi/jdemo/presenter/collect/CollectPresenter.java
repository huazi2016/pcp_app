package com.huazi.jdemo.presenter.collect;
...
import com.huazi.jdemo.model.CollectModel;
...
public class CollectPresenter extends BasePresenter<Contract.ICollectView> implements Contract.ICollectPresenter {
    ...
    public void unCollect(int articleId, int originId) {
        iCollectModel.unCollect(articleId, originId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<com.huazi.jdemo.bean.collect.Collect>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                        mCompositeDisposable.add(d);
                    }
                    ...
                    @Override
                    public void onNext(com.huazi.jdemo.bean.collect.Collect collect) {
                        if (isViewAttached()) {
