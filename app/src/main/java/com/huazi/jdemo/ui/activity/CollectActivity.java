...
import com.huazi.jdemo.custom.CustomDialog;
import com.huazi.jdemo.custom.loading.LoadingView;
import com.huazi.jdemo.R;
import com.huazi.jdemo.adapter.CollectAdaper;
...
import com.huazi.jdemo.presenter.collect.CollectPresenter;
...
public class CollectActivity extends BaseActivity<Contract.ICollectView, CollectPresenter> implements Contract.ICollectView,
    ...
    @Override
    public void onUnCollect(com.huazi.jdemo.bean.collect.Collect collect, int articleId) {
        if (collect != null) {
